...
class KpiSubmissionImageResizer
{
    public function store(UploadedFile $file, int $maxDimension = 300): string
    {
        ...
        $path = 'kpi-task-submissions/' . now()->format('Y/m') . '/' . Str::uuid() . '.' . $extension;
