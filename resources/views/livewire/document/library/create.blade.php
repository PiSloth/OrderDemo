<div class="space-y-6" x-data="{ locked: false }" x-on:document-save-failed.window="locked = false">
    <div x-show="locked" style="display:none"
        ...
        <div
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <div class="text-sm font-semibold text-slate-900 dark:text-white">Uploading document…</div>
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-xl font-semibold text-slate-900 dark:text-white">Create Document</h1>
            <p class="text-sm text-slate-500 dark:text-slate-300">Post a new document with rich formatting.</p>
        </div>
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        ...
                        <input type="text" wire:model.live="new_document_type" placeholder="Procedure, Workflow, Job Description, Policy..."
                            class="block w-full mt-1 border rounded-md border-slate-300 dark:border-slate-600 dark:bg-slate-900 dark:text-white" />
