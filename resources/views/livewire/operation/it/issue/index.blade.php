    ...
    <section class="space-y-5">
        ...
        <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
            ...
            <div>
                ...
                <input id="due_date" type="datetime-local" wire:model.defer="due_date" class="rounded-xl border px-3 py-2"
                    placeholder="Due date">
            </div>
            <!-- <label for="resolution_sequence" class="text-sm font-medium text-slate-700">Fix Sequence</label>
                <input id="resolution_sequence" type="number" min="1" wire:model.defer="resolution_sequence" class="rounded-xl border px-3 py-2"
                    placeholder="Fix sequence (1,2,3...)"> -->

            <label class="flex items-center gap-2 rounded-xl border px-3 py-2">
                <input type="checkbox" wire:model="is_third_party_resolver">
                <span>Third-party resolver</span>
            </label>
            <div>
                <label for="follow_up_date" class="text-sm font-medium text-slate-700">Follow Up Date</label>
                <input id="follow_up_date" type="datetime-local" wire:model.defer="follow_up_date" class="rounded-xl border px-3 py-2"
