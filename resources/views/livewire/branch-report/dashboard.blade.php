<div class="space-y-8" x-data="{ modalOpen: @entangle('show_target_modal').live, compareHelpOpen: false, calendarHelpOpen: false, avgHelpOpen: false, achievementHelpOpen: false }"
    x-effect="document.body.classList.toggle('overflow-hidden', modalOpen || compareHelpOpen || calendarHelpOpen || avgHelpOpen || achievementHelpOpen)">
    {{-- index Chart --}}
    <div class="max-w-4xl p-6 mx-auto my-4 bg-white rounded-lg shadow-xl dark:bg-gray-800">
        <div class="grid grid-cols-1 gap-3 md:grid-cols-2 md:items-end">
            ...
            <div class="text-gray-700 dark:text-gray-200 md:text-right">
                <span>Report at -
                    {{ \Carbon\Carbon::create((int) $index_year_filter, (int) $index_month_filter, 1)->format('M, Y') }}</span>
            </div>
        </div>
    ...
    <div class="max-w-4xl p-6 mx-auto my-4 bg-white rounded-lg shadow-xl dark:bg-gray-800">
        ...
        <div class="grid grid-cols-1 gap-3 md:grid-cols-3 md:items-end">
            <div class="w-full" wire:ignore x-data="{
                ...
                <div class="mt-1 text-xs text-gray-500 dark:text-gray-400">Compares by day index across the selected
                    period.</div>
            </div>

            <div class="w-full">
                <x-select label="Branches" placeholder="Select branches" multiselect searchable :options="$jewelryBranches"
                    option-label="name" option-value="id" wire:model.live="sale_compare_branch_ids" />
            </div>

            <div class="w-full">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Metric</label>
                <select wire:model.live="sale_compare_metric"
                ...
                <div class="mt-1 text-xs text-gray-500 dark:text-gray-400">Choose to compare sale gram or sale pcs.
                </div>
            </div>

            <div class="flex flex-wrap gap-2">
                <button type="button" wire:click="presetQuarterlyCompare"
                    class="px-3 py-2 rounded-md text-sm font-medium border bg-white text-gray-700 border-gray-300 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600">Quarterly
                    Compare</button>
                <button type="button" wire:click="presetHalfYearCompare"
                    class="px-3 py-2 rounded-md text-sm font-medium border bg-white text-gray-700 border-gray-300 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600">Half-Year
                    Compare</button>
                <button type="button" wire:click="presetMonthYoYCompare"
                    class="px-3 py-2 rounded-md text-sm font-medium border bg-white text-gray-700 border-gray-300 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600">Month
                    YoY</button>
            </div>
        </div>

        <div class="mt-4 flex flex-wrap gap-2">
            <button type="button" wire:click="setSaleCompareMode('prev_period')"
                class="px-3 py-2 rounded-md text-sm font-medium border bg-white text-gray-700 border-gray-300 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600">Compare
                Prev Period</button>
            <button type="button" wire:click="setSaleCompareMode('yoy')"
                class="px-3 py-2 rounded-md text-sm font-medium border bg-white text-gray-700 border-gray-300 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600">Compare
                YoY</button>
            <button type="button" wire:click="setSaleCompareMode('none')"
                class="px-3 py-2 rounded-md text-sm font-medium border bg-white text-gray-700 border-gray-300 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600">No
                Compare</button>
        </div>
    ...
    <div x-cloak x-show="compareHelpOpen" x-on:keydown.escape.window="compareHelpOpen = false"
        x-on:click.self="compareHelpOpen = false" class="fixed inset-0 z-50 bg-black/50 p-4" aria-modal="true"
        role="dialog">
        <div class="w-full max-w-2xl mx-auto bg-white rounded-lg shadow-xl dark:bg-gray-800 overflow-hidden"
            style="max-height: calc(100vh - 2rem);">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <div>
                    <h3 class="text-lg font-bold text-gray-700 dark:text-gray-200">Sale Compare Chart အသုံးပြုပုံ</h3>
                    <div class="text-sm text-gray-500 dark:text-gray-400">Date Range + Compare Mode ကိုသုံးပြီး
                        နှိုင်းယှဉ်ကြည့်နိုင်ပါတယ်</div>
                </div>
                <button type="button"
                    class="px-3 py-2 rounded-md text-sm font-medium border bg-white text-gray-700 border-gray-300 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600"
                    x-on:click="compareHelpOpen = false">
                    ပိတ်မယ်
                </button>
            </div>
            ...
            <div class="px-6 py-4 overflow-y-auto" style="max-height: calc(100vh - 12rem);">
                <div class="space-y-4 text-sm text-gray-700 dark:text-gray-200">
                    <div class="p-3 rounded-lg bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                        ...
                        <div class="space-y-2">
                            <div><span class="font-medium">(1)</span> <span class="font-medium">Sale Date Range</span>
                                မှာ <span class="font-medium">2026-12-01</span> ကနေ <span
                                    class="font-medium">2026-12-31</span> အထိရွေးပါ။</div>
                            <div><span class="font-medium">(2)</span> Branch ကို (All / သို့) လိုတဲ့ Branch(တွေ) ရွေးပါ။
                            </div>
                            <div><span class="font-medium">(3)</span> <span class="font-medium">Compare YoY</span>
                                ခလုတ်ကိုနှိပ်ပါ။ (YoY = အရင်နှစ်တူညီတဲ့ကာလနဲ့ နှိုင်းခြင်း)</div>
                            <div class="text-xs text-gray-500 dark:text-gray-400">ဥပမာ Dec 2026 ရွေးထားရင် Compare YoY က
                                Dec 2025 ကို အလိုအလျောက်နှိုင်းပေးပါတယ်။</div>
                        </div>
                    </div>
                    ...
                    <div class="p-3 rounded-lg bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                        ...
                        <div class="space-y-2">
                            <div><span class="font-medium">Compare Prev Period</span> = ရွေးထားတဲ့ ရက်အရေအတွက်အတိုင်း
                                အရင်ကာလနဲ့နှိုင်း (ဥပမာ 10 ရက်ရွေးရင် အရင် 10 ရက်နဲ့)</div>
                            <div><span class="font-medium">Compare YoY</span> = အရင်နှစ် တူညီတဲ့နေ့ရက်အတွဲနဲ့နှိုင်း
                            </div>
                            <div><span class="font-medium">No Compare</span> = ရွေးထားတဲ့ ကာလကိုပဲပြ
                                (နှိုင်းခြင်းမလုပ်)</div>
                            <div><span class="font-medium">Month YoY</span> = ဒီလ(အခုလ) ကို အလိုအလျောက်ရွေးပြီး YoY
                                နဲ့နှိုင်း (Dec လကိုလိုချင်ရင် Date Range ကို ကိုယ်တိုင် Dec ရက်တွေရွေးပြီး Compare YoY
                                နှိပ်ပါ)</div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="space-y-2">
                            <div><span class="font-medium">Actual</span> လိုင်း = ရွေးထားတဲ့ Date Range အတွင်း
                                စုစုပေါင်း Sale Gram ကိုနေ့စဉ်အလိုက်ပြပါတယ်။</div>
                            <div><span class="font-medium">Compare</span> လိုင်း = ရွေးထားတဲ့ Mode (Prev/YoY) အလိုက်
                                နှိုင်းတဲ့ကာလကိုနေ့စဉ်အလိုက်ပြပါတယ်။</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="max-w-4xl p-6 mx-auto my-4 bg-white rounded-lg shadow-xl dark:bg-gray-800">
        <div class="flex flex-col gap-3 mb-4 md:flex-row md:items-center md:justify-between">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <button wire:click="previousMonth"
                    class="px-3 py-1 text-white bg-blue-500 rounded hover:bg-blue-600">&lt;</button>
                <span
                    class="text-lg font-semibold text-gray-700 dark:text-gray-200">{{ \Carbon\Carbon::create($calendar_year, $calendar_month)->format('F Y') }}</span>
                <button wire:click="nextMonth"
                    class="px-3 py-1 text-white bg-blue-500 rounded hover:bg-blue-600">&gt;</button>

                <div class="w-full sm:w-44">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Matrix</label>
                    <select wire:model.live="calendar_metric"
                        class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                        <option value="gram">Gram</option>
                        <option value="pcs">Pcs</option>
                    </select>
                ...
                <button type="button" wire:click="downloadTargetsExcel"
                    class="px-3 py-2 rounded-md text-sm font-medium border bg-white text-gray-700 border-gray-300 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600">
                    Download Excel
                </button>
                ...
                <button type="button"
                    class="px-3 py-2 rounded-md text-sm font-medium border bg-white text-gray-700 border-gray-300 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600"
                    x-on:click="calendarHelpOpen = true">
                    အသုံးပြုပုံ (မြန်မာ)
                </button>

                <div class="flex flex-col sm:flex-row sm:items-center gap-2 w-full md:w-auto">
                    <input type="file" wire:model="targets_import_file" accept=".xlsx,.csv,.ods"
                        class="block w-full md:max-w-[220px] text-sm text-gray-700 dark:text-gray-200" />
                    <button type="button" wire:click="importTargetsExcel"
                        class="px-3 py-2 w-full sm:w-auto text-white bg-blue-600 rounded hover:bg-blue-700"
                        wire:loading.attr="disabled" wire:target="targets_import_file,importTargetsExcel"
                        wire:loading.class="opacity-60 cursor-not-allowed">
                        Import
                    </button>
                </div>

                <div class="hidden items-center gap-2 text-sm text-gray-600 dark:text-gray-300"
                    wire:loading.class="flex" wire:loading.class.remove="hidden" wire:target="targets_import_file">
                ...
                <div class="hidden items-center gap-2 text-sm text-gray-600 dark:text-gray-300"
                    wire:loading.class="flex" wire:loading.class.remove="hidden" wire:target="importTargetsExcel">
                    <div class="w-4 h-4 border-2 border-gray-300 border-t-blue-600 rounded-full animate-spin"></div>
        ...
        <div class="grid grid-cols-7 gap-1">
            ...
            @foreach ($calendarData as $dayData)
                @php
                    $metric = ($calendar_metric ?? 'gram') === 'pcs' ? 'pcs' : 'gram';
                    $targetKey = $metric === 'pcs' ? 'target_pcs' : 'target_gram';
                    $actualKey = $metric === 'pcs' ? 'actual_pcs' : 'actual_gram';
                    $decimals = $metric === 'pcs' ? 0 : 2;

                    $isToday = $dayData['date'] === now()->format('Y-m-d');
                    $cellClass =
                        'p-3 text-center border border-gray-300 rounded cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 dark:border-gray-600';
                    if ($isToday) {
                        $cellClass .= ' bg-blue-50 dark:bg-blue-900 border-blue-300 dark:border-blue-600';
                    } elseif (
                        ($dayData[$actualKey] ?? 0) >= ($dayData[$targetKey] ?? 0) &&
                        ($dayData[$targetKey] ?? 0) > 0
                    ) {
                ...
                <div wire:click="openTargetModal('{{ $dayData['date'] }}')" class="{{ $cellClass }}">
                    <div
                        class="font-semibold {{ $isToday ? 'text-blue-600 dark:text-blue-400' : (($dayData[$actualKey] ?? 0) >= ($dayData[$targetKey] ?? 0) && ($dayData[$targetKey] ?? 0) > 0 ? 'text-green-600 dark:text-green-400' : '') }}">
                        {{ $dayData['day'] }}</div>
                    @if (($dayData[$targetKey] ?? 0) > 0 || ($dayData[$actualKey] ?? 0) > 0)
                        <div class="text-xs flex justify-between items-center">
                            <span
                                class="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 px-1 py-0.5 rounded text-xs font-medium">T:
                                {{ number_format((float) ($dayData[$targetKey] ?? 0), $decimals) }}</span>
                            <span
                                class="bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200 px-1 py-0.5 rounded text-xs font-medium">A:
                                {{ number_format((float) ($dayData[$actualKey] ?? 0), $decimals) }}</span>
                        </div>
                    @else
    ...
    <div x-cloak x-show="calendarHelpOpen" x-on:keydown.escape.window="calendarHelpOpen = false"
        x-on:click.self="calendarHelpOpen = false" class="fixed inset-0 z-50 bg-black/50 p-4" aria-modal="true"
        role="dialog">
        <div class="w-full max-w-2xl mx-auto bg-white rounded-lg shadow-xl dark:bg-gray-800 overflow-hidden"
            style="max-height: calc(100vh - 2rem);">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <div>
                    <h3 class="text-lg font-bold text-gray-700 dark:text-gray-200">Calendar / Monthly Target
                        အသုံးပြုပုံ</h3>
                    <div class="text-sm text-gray-500 dark:text-gray-400">Target ထည့်နည်း၊ Export/Import ဖိုင်ပုံစံ
                    </div>
                </div>
                <button type="button"
                    class="px-3 py-2 rounded-md text-sm font-medium border bg-white text-gray-700 border-gray-300 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600"
                    x-on:click="calendarHelpOpen = false">
                    ပိတ်မယ်
                </button>
            </div>
            ...
            <div class="px-6 py-4 overflow-y-auto" style="max-height: calc(100vh - 12rem);">
                <div class="space-y-4 text-sm text-gray-700 dark:text-gray-200">
                    <div
                        ...
                        <div class="space-y-2">
                            <div>နေ့တိုင်းအတွက် <span class="font-medium">Target (T)</span> နဲ့ <span
                                    class="font-medium">Actual (A)</span> ကိုပြပါတယ်။</div>
                    ...
                    <div
                        ...
                        <div class="space-y-2">
                            <div>ရွေးထားတဲ့ လ (Calendar ထဲက <span class="font-medium">F Y</span>) အတွက် Target
                                ဒေတာတွေကို Excel ဖိုင်နဲ့ထုတ်ပေးပါတယ်။</div>
                            <div>ဒီဖိုင်ကို သင့် Excel မှာပြင်ပြီး <span class="font-medium">Import</span>
                                ပြန်တင်နိုင်ပါတယ်။</div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="space-y-2">
                            ...
                            <div><span class="font-medium">အရေးကြီး:</span> Row တစ်ခုချင်းစီမှာ <span
                                    class="font-medium">target_gram</span> နဲ့ <span
                                    class="font-medium">target_pcs</span> နှစ်ခုလုံးထည့်ထားရပါမယ်။</div>
                            <div>ဖိုင်ထဲက <span class="font-medium">date</span> ဟာ လက်ရှိရွေးထားတဲ့
                                လထဲကနေ့ရက်တွေဖြစ်ရပါမယ်။</div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="text-xs text-gray-500 dark:text-gray-400 mb-2">Column ခေါင်းစဉ်တွေကို
                            မပြောင်းပါနဲ့။</div>
                            ...
                            <table class="w-full text-xs text-left border border-gray-200 dark:border-gray-700">
                                <thead class="bg-gray-100 dark:bg-gray-800">
                                    <tr class="text-gray-700 dark:text-gray-200">
                                        ...
                                        <th class="px-2 py-1 border-b border-gray-200 dark:border-gray-700">branch_id
                                        </th>
                                        <th class="px-2 py-1 border-b border-gray-200 dark:border-gray-700">branch_name
                                        </th>
                                        <th class="px-2 py-1 border-b border-gray-200 dark:border-gray-700">target_gram
                                        </th>
                                        <th class="px-2 py-1 border-b border-gray-200 dark:border-gray-700">target_pcs
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class="text-gray-700 dark:text-gray-200">
                                        <td class="px-2 py-1 border-t border-gray-200 dark:border-gray-700">2026-01-01
                                        </td>
                                        <td class="px-2 py-1 border-t border-gray-200 dark:border-gray-700">1</td>
                                        <td class="px-2 py-1 border-t border-gray-200 dark:border-gray-700">Branch A
                                        </td>
    ...
    <div class="max-w-4xl p-6 mx-auto my-4 bg-white rounded-lg shadow-xl dark:bg-gray-800">
        <div class="flex flex-col gap-3 mb-4 md:flex-row md:items-end md:justify-between">
            <h2 class="text-xl font-bold text-gray-700 dark:text-gray-200">Target vs Actual Sales
                ({{ \Carbon\Carbon::create($calendar_year, $calendar_month)->format('F Y') }})</h2>

            <div class="w-full md:w-44">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Metric</label>
                <select wire:model.live="target_vs_actual_metric"
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    <option value="gram">Gram</option>
                    <option value="pcs">Pcs</option>
                </select>
    ...
    <div class="max-w-4xl p-6 mx-auto my-4 bg-white rounded-lg shadow-xl dark:bg-gray-800">
        <div class="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            ...
            <div class="w-full md:w-72">
                <x-select label="Branch" placeholder="All jewelry branches" :options="$jewelryBranches" option-label="name"
                    option-value="id" wire:model.live="avg_target_branch_id" />
            </div>
        </div>
        ...
        <div class="mt-4 grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
            <div class="p-3 rounded-lg bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                ...
                <div class="font-semibold text-gray-700 dark:text-gray-200">
                    {{ number_format((float) ($avgRemainingTargets['month_target_gram'] ?? 0), 2) }}</div>
            </div>
            <div class="p-3 rounded-lg bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                <div class="text-gray-500 dark:text-gray-400">Month Target (pcs)</div>
                <div class="font-semibold text-gray-700 dark:text-gray-200">
                    {{ number_format((float) ($avgRemainingTargets['month_target_pcs'] ?? 0), 2) }}</div>
            </div>
            <div class="p-3 rounded-lg bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                <div class="text-gray-500 dark:text-gray-400">Sold To Date (g / pcs)</div>
                <div class="font-semibold text-gray-700 dark:text-gray-200">
                    {{ number_format((float) ($avgRemainingTargets['actual_to_date_gram'] ?? 0), 2) }} /
                    {{ number_format((float) ($avgRemainingTargets['actual_to_date_pcs'] ?? 0), 2) }}
                </div>
            </div>
            <div class="p-3 rounded-lg bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                <div class="text-gray-500 dark:text-gray-400">Days Remaining</div>
                <div class="font-semibold text-gray-700 dark:text-gray-200">
                    {{ (int) ($avgRemainingTargets['days_remaining'] ?? 0) }}</div>
            </div>
        </div>
    ...
    <div class="max-w-4xl p-6 mx-auto my-4 bg-white rounded-lg shadow-xl dark:bg-gray-800">
        <div class="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div>
                ...
                <div class="text-sm text-gray-500 dark:text-gray-400">
                    Last {{ (int) ($achievement_days ?? 7) }} days · {{ $branchAchievementHeatmap['from'] ?? '' }} to
                    {{ $branchAchievementHeatmap['to'] ?? '' }}
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-3 md:grid-cols-2 md:w-[28rem]">
                <div class="w-full">
                    ...
                    <input type="number" min="7" max="31" wire:model.live="achievement_days"
                        class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white" />
                    <div class="mt-1 text-xs text-gray-500 dark:text-gray-400">Shows daily achievement for every
                        jewelry branch.</div>
                </div>
                ...
                <div class="w-full">
                    ...
                    <div class="mt-1 text-xs text-gray-500 dark:text-gray-400">Achievement% = Actual ÷ Target × 100.
                        Empty cell = no target.</div>
                </div>
            </div>
        </div>
    ...
    <div x-cloak x-show="achievementHelpOpen" x-on:keydown.escape.window="achievementHelpOpen = false"
        x-on:click.self="achievementHelpOpen = false" class="fixed inset-0 z-50 bg-black/50 p-4" aria-modal="true"
        role="dialog">
        <div class="w-full max-w-2xl mx-auto bg-white rounded-lg shadow-xl dark:bg-gray-800 overflow-hidden"
            style="max-height: calc(100vh - 2rem);">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <div>
                    <h3 class="text-lg font-bold text-gray-700 dark:text-gray-200">Branch Target Achievement (Heatmap)
                        အသုံးပြုပုံ</h3>
                    <div class="text-sm text-gray-500 dark:text-gray-400">Branch တိုင်းရဲ့ နေ့စဉ် Target ပြည့်မပြည့်ကို
                        အရောင်နဲ့ မြန်မြန်မြင်နိုင်တဲ့ report ပါ</div>
                </div>
                <button type="button"
                    class="px-3 py-2 rounded-md text-sm font-medium border bg-white text-gray-700 border-gray-300 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600"
                    x-on:click="achievementHelpOpen = false">
                    ပိတ်မယ်
                </button>
            </div>
            ...
            <div class="px-6 py-4 overflow-y-auto" style="max-height: calc(100vh - 12rem);">
                <div class="space-y-4 text-sm text-gray-700 dark:text-gray-200">
                    <div
                        ...
                        <div class="space-y-2">
                            <div>Heatmap က <span class="font-medium">ဇယားပုံစံ (grid)</span> လိုပါပဲ။ တန်ဖိုးကို
                                အရောင်အလင်း/အမှောင်နဲ့ ပြပေးတဲ့ chart ဖြစ်လို့ အခြေအနေကို အမြန်ဆုံး သိနိုင်ပါတယ်။</div>
                            <div>ဒီ report မှာတော့ <span class="font-medium">နေ့စဉ် Target Achievement%</span> ကို
                                အရောင်နဲ့ ပြပါတယ်။</div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="space-y-2">
                            ...
                            <div><span class="font-medium">Column (အကွက်)</span> တစ်ကော်လံ = တစ်ရက် (နောက်ဆုံး N ရက်)
                            </div>
                            <div><span class="font-medium">Cell (အကွက်)</span> တစ်ခု = အဲဒီ Branch ရဲ့ အဲဒီရက် <span
                                    class="font-medium">Achievement%</span></div>
                            <div>အကွက်ပေါ်မှာ <span class="font-medium">မော်စ်တင် (hover)</span> လုပ်ရင် Tooltip မှာ
                                Actual/Target/Percent ကို အသေးစိတ်မြင်နိုင်ပါတယ်။</div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="space-y-2">
                            ...
                            <div>Target မရှိတဲ့နေ့ (Target = 0) ဆိုရင် အဲဒီကွက်ကို <span class="font-medium">ဗလာ (No
                                    target)</span> လို့ပြပါမယ်။</div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="space-y-2">
                            <div>အရောင်က Achievement% အပေါ်မူတည်ပြီး ပြောင်းပါတယ်။ (အောက်က range တွေက chart ထဲမှာ
                                သုံးထားတဲ့ range အတိအကျပါ)</div>
                            <div>
                                <div class="flex flex-col gap-1">
                                    <div><span class="font-medium text-red-600 dark:text-red-400">အနီ</span> = &lt;50%
                                        (အရမ်းနည်း)</div>
                                    <div><span
                                            class="font-medium text-amber-500 dark:text-amber-300">အဝါ-လိမ္မော်</span>
                                        = 50–79%</div>
                                    <div><span class="font-medium text-yellow-500 dark:text-yellow-300">အဝါ</span> =
                                        80–99% (Target မပြည့်သေး)</div>
                                    <div><span class="font-medium text-green-600 dark:text-green-400">အစိမ်း</span> =
                                        100–119% (Target ပြည့်/ကျော်)</div>
                                    <div><span class="font-medium text-blue-600 dark:text-blue-400">အပြာ</span> = 120%+
                                        (Target အလွန်ကျော်)</div>
                                    <div><span class="font-medium">No target</span> = Target မသတ်မှတ်ထားတဲ့နေ့ (Target
                                        = 0) / မတွက်နိုင်တဲ့နေ့</div>
                                </div>
                            </div>
                            <div class="text-xs text-gray-500 dark:text-gray-400">(အရောင် range တွေကို chart ထဲက rule
                                အတိုင်း အုပ်စုခွဲထားပါတယ်)</div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="space-y-2">
                            <div><span class="font-medium">Days (min 7)</span> = နောက်ဆုံး ဘယ်နှစ်ရက်ကို ပြမလဲ
                                (အနည်းဆုံး 7 ရက်) ကိုသတ်မှတ်တာပါ။</div>
                            <div><span class="font-medium">Metric</span> = Gram (အလေးချိန်) သို့မဟုတ် Pcs (အရေအတွက်)
                                ကိုရွေးပြီး Achievement% ကိုတွက်ပြပါတယ်။</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div x-cloak x-show="avgHelpOpen" x-on:keydown.escape.window="avgHelpOpen = false"
        x-on:click.self="avgHelpOpen = false" class="fixed inset-0 z-50 bg-black/50 p-4" aria-modal="true"
        role="dialog">
        <div class="w-full max-w-2xl mx-auto bg-white rounded-lg shadow-xl dark:bg-gray-800 overflow-hidden"
            style="max-height: calc(100vh - 2rem);">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <div>
                    <h3 class="text-lg font-bold text-gray-700 dark:text-gray-200">Remaining Daily Target (Avg) ရဲ့
                        အဓိပ္ပါယ်</h3>
                    <div class="text-sm text-gray-500 dark:text-gray-400">ဒီလအတွက် လက်ကျန် Target ကို နေ့စဉ်အလိုက်
                        ဘယ်လောက်လုပ်ရမလဲ ဆိုတာကို တွက်ပြပါတယ်</div>
                </div>
                <button type="button"
                    class="px-3 py-2 rounded-md text-sm font-medium border bg-white text-gray-700 border-gray-300 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600"
                    x-on:click="avgHelpOpen = false">
                    ပိတ်မယ်
                </button>
            </div>
            ...
            <div class="px-6 py-4 overflow-y-auto" style="max-height: calc(100vh - 12rem);">
                <div class="space-y-4 text-sm text-gray-700 dark:text-gray-200">
                    <div
                        ...
                        <div class="space-y-2">
                            <div>ဒီလအတွက် သတ်မှတ်ထားတဲ့ <span class="font-medium">Target (Gram / Pcs)</span> ကို
                                ယနေ့အထိ ရောင်းပြီးသားပမာဏနဲ့ နှိုင်းပြီး <span class="font-medium">လက်ကျန်</span>
                                ကိုတွက်ပါတယ်။</div>
                            <div>နောက်ကျန်နေတဲ့ ရက်တွေကို ထပ်တူမျှဝေပြီး <span class="font-medium">နေ့စဉ်လိုအပ်တဲ့ Avg
                                    Target</span> ကိုပြပါတယ်။</div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="space-y-2">
                            <div><span class="font-medium">(1) Month Target</span> = ဒီလအတွင်း ထည့်ထားတဲ့ daily target
                                တွေကို စုစုပေါင်း (Gram / Pcs) လုပ်ပါတယ်။</div>
                            <div><span class="font-medium">(2) Sold To Date</span> = ဒီလအစကနေ ယနေ့အထိ ရောင်းပြီးသား
                                (Gram / Pcs) ကို စုပါတယ်။</div>
                            <div><span class="font-medium">(3) Remaining</span> = Month Target − Sold To Date. အကယ်လို့
                                အနုတ်ဖြစ်သွားရင် 0 လို့ယူပါတယ်။</div>
                            <div><span class="font-medium">(4) Days Remaining</span> = ဒီလအတွက် ယနေ့နောက်ကျန်တဲ့
                                ရက်အရေအတွက် (မနက်ဖြန်ကနေ လကုန်အထိ) ပါ။</div>
                            <div><span class="font-medium">(5) Required Avg/Day (Remaining)</span> = Remaining ÷ Days
                                Remaining. Days Remaining = 0 ဖြစ်ရင် 0 ပြပါတယ်။</div>
                        </div>
                    </div>
    ...
    <div class="max-w-4xl p-6 mx-auto my-4 bg-white rounded-lg shadow-xl dark:bg-gray-800">
        ...
        <div class="grid grid-cols-1 gap-3 mb-4 md:grid-cols-3 md:items-end">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Metric</label>
                <select wire:model.live="target_actual_metric"
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    <option value="gram">Gram</option>
                    <option value="pcs">Pcs</option>
                </select>
                <div class="mt-1 text-xs text-gray-500 dark:text-gray-400">Switch target/actual between gram and pcs.
                </div>
            </div>
        </div>
        ...
        <div class="overflow-x-auto">
            ...
            @endphp
            <table
                class="w-full text-sm text-left text-gray-700 bg-white rounded-lg dark:text-gray-200 dark:bg-gray-800">
                ...
                <tbody>
                    ...
                    <tr class="font-semibold bg-gray-100 dark:bg-gray-900">
                        ...
                        <td class="px-3 py-2 text-right">
                            {{ number_format((float) ($totals['target'] ?? 0), $decimals) }}</td>
                        <td class="px-3 py-2 text-right">
                            {{ number_format((float) ($totals['actual'] ?? 0), $decimals) }}</td>
                        @php
                            $tg = (float) ($totals['gap'] ?? 0);
                            $tgClass =
                                $tg >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400';
                        @endphp
                        ...
                        <td class="px-3 py-2 text-right">
                            ...
                            @else
                                <span
                                    class="{{ $totalIsUp ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                    ...
                    @foreach ($rows as $row)
                        ...
                        <tr class="odd:bg-white even:bg-gray-50 dark:odd:bg-gray-800 dark:even:bg-gray-900">
                            ...
                            <td class="px-3 py-2 text-right {{ $gapClass }}">{{ number_format($gap, $decimals) }}
                            </td>
                            <td class="px-3 py-2 text-right">
                                @if (is_null($percent))
                                    <span class="text-gray-400">-</span>
                                @else
                                    <span
                                        class="{{ $isUp ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                    ...
                    @if (empty($rows))
                        <tr>
                            <td colspan="5" class="px-3 py-4 text-center text-gray-500 dark:text-gray-400">No
                                target/actual data for selected range.</td>
                        </tr>
                    @endif
                </tbody>
            </table>
    ...
    <div class="max-w-4xl p-6 mx-auto my-4 bg-white rounded-lg shadow-xl dark:bg-gray-800">
        <div class="flex flex-col md:flex-row w-full gap-2 mx-auto mb-4 md:w-1/2">
            <x-datetime-picker wire:model.live.debounce="popular_start_date_filter" without-time='true'
                label="Date" placeholder="Now" />
            <x-datetime-picker wire:model.live.debounce="popular_end_date_filter" without-time='true' label="Date"
                placeholder="Now" />
        </div>
        <div
            class="mb-4 text-gray-700 dark:text-gray-200 flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
            ...
            <table class="w-full bg-white border-collapse rounded-lg table-auto dark:bg-gray-800">
                ...
                <tbody>
                    @foreach ($most_popular_summary as $index => $summary)
                        <tr
                            class="{{ $index % 2 == 0 ? 'bg-gray-100 dark:bg-gray-900' : 'bg-white dark:bg-gray-800' }}">
                        ...
                        <tr>
                            <td colspan="5" class="align-top">
                                <details class="w-full">
                                    <summary class="text-sm text-blue-400 cursor-pointer dark:text-blue-300">view
                                        details
                                    </summary>
                                            ...
                                            @foreach ($most_popular_details as $detail)
                                                @if (
                                                    ...
                                                    <li class="flex justify-between shadow-sm">
                                                        ...
                                                        <span
                                                            class="p-2 text-right text-slate-800 dark:text-slate-200">
    ...
    @if ($show_target_modal)
        <div class="fixed inset-0 z-50 bg-black/50 p-4" x-on:keydown.escape.window="$wire.closeTargetModal()"
            x-on:click.self="$wire.closeTargetModal()" aria-modal="true" role="dialog">
            <div class="w-full max-w-2xl mx-auto bg-white rounded-lg shadow-xl dark:bg-gray-800 overflow-hidden"
                style="max-height: calc(100vh - 2rem);">
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <div>
                        ...
                        <div class="text-sm text-gray-500 dark:text-gray-400">
                            {{ \Carbon\Carbon::parse($selected_date)->format('M j, Y') }}</div>
                    </div>
                    <button type="button" wire:click="closeTargetModal"
                        class="px-3 py-2 rounded-md text-sm font-medium border bg-white text-gray-700 border-gray-300 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600">
                        Close
                    </button>
                </div>
                        ...
                        @foreach (\App\Models\Branch::where('is_jewelry_shop', true)->orderBy('name')->get() as $branch)
                            <div
                                ...
                                <div class="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                                    <div class="font-medium text-gray-700 dark:text-gray-200">{{ $branch->name }}
                                    </div>
                                    <div class="grid grid-cols-2 gap-2 w-full md:max-w-md">
                                        ...
                                        <div>
                                            ...
                                            <input type="number" step="1"
                                                wire:model="daily_targets_pcs.{{ $branch->id }}"
                                                class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                        </div>
                                    </div>
                                </div>
                ...
                <div
                    class="flex items-center justify-end gap-2 px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                    <button type="button" wire:click="closeTargetModal"
                        class="px-4 py-2 text-gray-600 bg-gray-200 rounded hover:bg-gray-300 dark:bg-gray-600 dark:text-gray-200">Cancel</button>
                    <button type="button" wire:click="saveTargets"
                        class="px-4 py-2 text-white bg-blue-600 rounded hover:bg-blue-700">Save Targets</button>
                </div>
            </div>
        </div>
    @endif
            ...
            const options = {
                ...
                tooltip: {
                    ...
                    custom: function({
                        ...
                        try {
                            const branch = (w && w.globals && w.globals.seriesNames) ? (w.globals
        ...
        document.addEventListener('livewire:init', function() {
            if (window.Livewire && typeof window.Livewire.on === 'function') {
                ...
                window.Livewire.on('target-vs-actual-chart-updated', function(payload) {
                    renderTargetVsActualLineChart(payload && payload.chart ? payload.chart :
                        payload);
                });
                ...
                window.Livewire.on('avg-remaining-target-chart-updated', function(payload) {
                    renderAvgRemainingTargetsChart(payload && payload.chart ? payload.chart :
                        payload);
                });

                window.Livewire.on('branch-achievement-heatmap-updated', function(payload) {
                    renderBranchAchievementHeatmap(payload && payload.chart ? payload.chart :
                        payload);
                });
            }
        });
