...
export default function TaskList({
    ...
    const handleArchiveTask = (taskId) => {
        setConfirmModal({
            isOpen: true,
            title: 'Archive Task',
            message: `Are you sure you want to archive task #${taskId}? It will be moved to the Restore List (Archived Tasks) where it can be restored anytime.`,
            confirmText: 'Yes, Archive Task',
            confirmVariant: 'amber',
            onConfirm: () => {
                    ...
                    >
                        ...
                        >
                            <div className="flex items-center gap-3">
                                <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-amber-100 text-amber-700 dark:bg-amber-950 dark:text-amber-300 font-extrabold text-lg">
                                    📦
                                </div>
                                <div>
                            ...
                            <div className="flex items-center justify-end gap-3 pt-2">
                                ...
                                <button
                                    ...
                                    className="rounded-xl bg-amber-600 px-5 py-2 text-xs font-bold text-white shadow-sm hover:bg-amber-700 active:scale-95 transition"
                                >
